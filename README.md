# Simulador de Pseudo-Sistema Operacional (PseudoSO)
...
## Como Executar o Simulador PseudoSO
...
As especificações de histórias de comportamento adicionais (BDD) individuais continuam disponíveis no subdiretório:
